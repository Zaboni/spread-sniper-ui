    ...
    <React.Fragment>
      ...
      >
        <ListItemButton
          ...
          sx={(theme) => ({
            height: mini ? 44 : 'auto',
            minHeight: mini ? 44 : 'auto',
            justifyContent: mini ? 'center' : 'flex-start',
            borderRadius: 1,
            '&.Mui-selected': {
              backgroundColor: 'rgba(2, 205, 13, 0.12)',
              borderLeft: '3px solid #02cd0d',
              ...
              '&:hover': {
                backgroundColor: 'rgba(2, 205, 13, 0.18)',
              },
            },
            '&:hover': {
...
{/* Removed mini text label - only show icons when collapsed */}
            </Box>
          ) : null}
          {!mini ? (
            <ListItemText
